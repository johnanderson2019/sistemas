...
require_once("include/Sensores_variables.php");
...
$layout = new TLayout("dashboard_bootstrap3", "OfficeOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "Sensores_dashboard";
...
$page_layouts["Sensores_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Sensores", "dashboard");
