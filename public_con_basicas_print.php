...
require_once("include/public_con_basicas_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "public_con_basicas_print";
...
$page_layouts["public_con_basicas_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.con_basicas" );
