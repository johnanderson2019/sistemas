...
require_once("include/public_fac_producto_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "public_fac_producto_edit";
...
$page_layouts["public_fac_producto_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap3", "OfficeOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "public_fac_producto_list";
...
$page_layouts["public_fac_producto_list"] = $layout;
...
$keys = array();
$keys["id_producto"] = postvalue("editid1");
