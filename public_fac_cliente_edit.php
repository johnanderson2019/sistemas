...
require_once("include/public_fac_cliente_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "public_fac_cliente_edit";
...
$page_layouts["public_fac_cliente_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "public_fac_cliente_list";
...
$page_layouts["public_fac_cliente_list"] = $layout;
...
$keys = array();
$keys["id_cliente"] = postvalue("editid1");
