...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("public.seg_usuarios", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "public.seg_usuarios" ] = array( "url" => "public_seg_usuarios", "type" => 0 );
	$projectEntitiesReverse[ "public_seg_usuarios" ] = "public.seg_usuarios";
	...
	$projectEntities[ "public.seguridad_uggroups" ] = array( "url" => "public_seguridad_uggroups", "type" => 0 );
	$projectEntitiesReverse[ "public_seguridad_uggroups" ] = "public.seguridad_uggroups";
	$projectEntities[ "public.org_empresa" ] = array( "url" => "public_org_empresa", "type" => 0 );
	$projectEntitiesReverse[ "public_org_empresa" ] = "public.org_empresa";
	$projectEntities[ "public.fac_cliente" ] = array( "url" => "public_fac_cliente", "type" => 0 );
	$projectEntitiesReverse[ "public_fac_cliente" ] = "public.fac_cliente";
	$projectEntities[ "public.fac_producto" ] = array( "url" => "public_fac_producto", "type" => 0 );
	$projectEntitiesReverse[ "public_fac_producto" ] = "public.fac_producto";
}
