...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("public.seg_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("public.seguridad_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("public.seg_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("public.seg_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("public.seguridad_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("public.org_empresa" == $this->chrt_array['tables'][0])
			return true;
		if("public.fac_cliente" == $this->chrt_array['tables'][0])
			return true;
		if("public.fac_producto" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
