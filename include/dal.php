...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("public.seg_usuarios");
}
...
class tDAL
{
	var $tblfullcalendar_at_localhost_public_fac_cliente;
	var $tblfullcalendar_at_localhost_public_fac_producto;
	var $tblfullcalendar_at_localhost_public_org_empresa;
	var $tblfullcalendar_at_localhost_public_seg_usuarios;
	var $tblfullcalendar_at_localhost_public_seguridad_uggroups;
	var $tblfullcalendar_at_localhost_public_seguridad_ugmembers;
	var $tblfullcalendar_at_localhost_public_seguridad_ugrights;
	var $tblfullcalendar_at_localhost_public_siigo_settings;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "fac_cliente", "varname" => "fullcalendar_at_localhost_public_fac_cliente", "altvarname" => "fac_cliente", "connId" => "fullcalendar_at_localhost", "schema" => "public", "connName" => "fullcalendar at localhost");
		$this->lstTables[] = array("name" => "fac_producto", "varname" => "fullcalendar_at_localhost_public_fac_producto", "altvarname" => "fac_producto", "connId" => "fullcalendar_at_localhost", "schema" => "public", "connName" => "fullcalendar at localhost");
		$this->lstTables[] = array("name" => "org_empresa", "varname" => "fullcalendar_at_localhost_public_org_empresa", "altvarname" => "org_empresa", "connId" => "fullcalendar_at_localhost", "schema" => "public", "connName" => "fullcalendar at localhost");
		$this->lstTables[] = array("name" => "seg_usuarios", "varname" => "fullcalendar_at_localhost_public_seg_usuarios", "altvarname" => "seg_usuarios", "connId" => "fullcalendar_at_localhost", "schema" => "public", "connName" => "fullcalendar at localhost");
		$this->lstTables[] = array("name" => "seguridad_uggroups", "varname" => "fullcalendar_at_localhost_public_seguridad_uggroups", "altvarname" => "seguridad_uggroups", "connId" => "fullcalendar_at_localhost", "schema" => "public", "connName" => "fullcalendar at localhost");
		$this->lstTables[] = array("name" => "seguridad_ugmembers", "varname" => "fullcalendar_at_localhost_public_seguridad_ugmembers", "altvarname" => "seguridad_ugmembers", "connId" => "fullcalendar_at_localhost", "schema" => "public", "connName" => "fullcalendar at localhost");
		$this->lstTables[] = array("name" => "seguridad_ugrights", "varname" => "fullcalendar_at_localhost_public_seguridad_ugrights", "altvarname" => "seguridad_ugrights", "connId" => "fullcalendar_at_localhost", "schema" => "public", "connName" => "fullcalendar at localhost");
		$this->lstTables[] = array("name" => "siigo_settings", "varname" => "fullcalendar_at_localhost_public_siigo_settings", "altvarname" => "siigo_settings", "connId" => "fullcalendar_at_localhost", "schema" => "public", "connName" => "fullcalendar at localhost");
	}
