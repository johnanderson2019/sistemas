...
class ConnectionManager
{
	...
	{
		return $this->byId( "fullcalendar_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 4;
		$data["connId"] = "fullcalendar_at_localhost";
		$data["connName"] = "fullcalendar at localhost";
		$data["connStringType"] = "postgre";
		$data["connectionString"] = "postgre;localhost;postgres;postgres;;SIIGO_EXP;;1;"; //currently unused

		$this->_connectionsIdByName["fullcalendar at localhost"] = "fullcalendar_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "postgres";
		$data["ODBCPWD"] = "postgres";
		$data["leftWrap"] = "\"";
		$data["rightWrap"] = "\"";
...
;
		...
		$connectionsData["fullcalendar_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["public.seg_usuarios"] = "fullcalendar_at_localhost";
		$connectionsIds["admin_rights"] = "fullcalendar_at_localhost";
		$connectionsIds["admin_members"] = "fullcalendar_at_localhost";
		$connectionsIds["admin_users"] = "fullcalendar_at_localhost";
		$connectionsIds["public.seguridad_uggroups"] = "fullcalendar_at_localhost";
		$connectionsIds["public.org_empresa"] = "fullcalendar_at_localhost";
		$connectionsIds["public.fac_cliente"] = "fullcalendar_at_localhost";
		$connectionsIds["public.fac_producto"] = "fullcalendar_at_localhost";
