...
$nonAdminTablesArr[] = "public.seg_usuarios";
$nonAdminTablesArr[] = "public.seguridad_uggroups";
$nonAdminTablesArr[] = "public.org_empresa";
$nonAdminTablesArr[] = "public.fac_cliente";
$nonAdminTablesArr[] = "public.fac_producto";
...
$wGroupTableName = $ug_connection->addTableWrappers( "public.seguridad_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "public.seguridad_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "public.seguridad_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "public.seguridad_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "public.seguridad_ugmembers" );
